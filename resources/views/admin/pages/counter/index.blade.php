...
@section('main-section')
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a href="{{route('show.trash.slider')}}" class="btn btn-sm btn-danger">Trash Counter <i class="fa fa-arrow-right"></i></a>
                </div>
                    ...
                    <div class="card-body">
                     @include('validate')
                        <form action="{{route('counter.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <button class="btn btn-sm btn-info show-icon">Select Icon</button>
                    
                                <input name="icon" type="text" value="{{old('icon')}}" class="form-control select-icon-show">
                              </div>
    ...
    <style>
        ...
        .select-icon-modal .preview-icon{
            font-size: 20px;
            cursor: pointer; 
            padding: 10px;
        ...
        .select-icon-modal .preview-icon code{
            padding-left: 5px;
            color: black;
            font-size: 14px;
             
        }
        .select-icon-modal .preview-icon code:hover{
            padding-left: 5px;
            color: #c7254e;
        }
        .select-icon-modal .preview-icon:hover{
            color: #c7254e;
        }
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row select-icon-modal">
                        <div class="col-md-4 col-sm-6 select-icon-modal-col">
