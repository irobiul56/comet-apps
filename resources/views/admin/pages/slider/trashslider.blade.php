        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a href="{{route('sliders.index')}}" class="btn btn-sm btn-success">Published Slider <i class="fa fa-arrow-right"></i></a>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <td>
                                                ...
                                                {{-- Trash --}}
                                                <a class="btn btn-sm btn-success" href="{{route('slide.trash', $item -> id)}}">Restore</i></a>
                                                <form action="{{route('sliders.destroy', $item -> id)}}" method="POST" class="d-inline delete-form">
                                                    @csrf
                                                    @method('DELETE')
