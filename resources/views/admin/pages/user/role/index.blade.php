                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul style="list-style: none; padding:0px;">
                                            @forelse (json_decode($per -> permissions) as $permi)
                                            <li><i class="fa fa-angle-right"></i>{{$permi}}</li>
                                            @empty
                                    ...
                                    <td>
                                     {{-- <a class="btn btn-sm btn-info" href="#"><i class="fa fa-eye"></i></a> --}}
                                        ...
                                        <form action="{{route('role.destroy', $per -> id)}}" method="POST" class="d-inline delete-form">
                                            @csrf
                                            @method('DELETE')
                        ...
                        <form action="{{route('role.update', $edit -> id)}}" method="POST">
                            ...
                            <div class="form-group">
                                <ul style="list-style:none; padding: 0px">
                                     ...
                                     <li>
                                         <label><input @if (in_array($item -> name, json_decode($edit -> permissions))) checked  @endif name="permission[]" value="{{$item -> name}}" type="checkbox">{{$item -> name}}</label>
                                     </li>
                                     @empty
                                     <li>
                                         <label for="" class="text-cemter text-danger">No Record Found</label>
